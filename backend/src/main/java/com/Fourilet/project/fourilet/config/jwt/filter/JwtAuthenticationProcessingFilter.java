package com.Fourilet.project.fourilet.config.jwt.filter;

import com.Fourilet.project.fourilet.config.jwt.util.PasswordUtil;
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse response, String refreshToken) {
        memberRepository.findByRefreshToken(refreshToken)
                .ifPresent(user -> {
                    ...
                    jwtService.sendAccessAndRefreshToken(response, jwtService.createAccessToken(user.getEmail(), user.getMemberId()),
